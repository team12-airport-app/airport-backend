...
public class RepositoryComposition__TestContext002_BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.PassengerRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AircraftRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AirportRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.FlightRepository.fragments#0'.
     */
